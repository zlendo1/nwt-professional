    ...
    filteredUsers.length > 0 && (
      <section className="right-side-bar">
            ...
            {filteredUsers?.length &&
              lengtConections.map((num, idx) => (
                <div
                  ...
                  className="preview"
                  onClick={() =>
                    history.push(`profile/${filteredUsers[num]?._id}`)
                  }
                >
                  <div className="img-container">
                    <img
                      src={filteredUsers[num]?.imgUrl}
                      className="img"
                      alt=""
                    />
                  </div>
        ...
        <div className="else-container">
          ...
          <div>
            <p>
              Looking for a full-stack developer for your project or team? I'm
              open to collaboration and exciting challenges.
            </p>
          </div>
          <br />
          <div className="img-container">
