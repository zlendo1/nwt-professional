...
public interface JobRepository extends JpaRepository<Job, Long> {
    ...
    @EntityGraph(attributePaths = "company")
    Page<Job> findByEmploymentType(@Param("employmentType") EmploymentType employmentType, Pageable pageable);

    // Fetch jobs by title, location, and company name with pagination and eager load company data
    @EntityGraph(attributePaths = "company")
    Page<Job> findByTitleContainingIgnoreCaseAndLocationContainingIgnoreCaseAndCompanyNameContainingIgnoreCase(
    ...
    @EntityGraph(attributePaths = "company")    // Fetch jobs by location with pagination and eager load company data
