...
public class UserControllerTest {
    ...
    public void testGetConversations() throws Exception {
        ...
        mockMvc.perform(get("/api/users/1/conversations"))
                .andExpect(status().isOk())
    ...
    public void testLinkWithConversation() throws Exception {
        ...
        mockMvc.perform(put("/api/users/1/link/conversation/1"))
                .andExpect(status().isOk());
    }

    @Test
    public void testLinkWithConversation_NotFound() throws Exception {
        doThrow(new EntityNotFoundException("User not found")).when(userService).linkWithConversation(1L, 1L);
    ...
    public void testUnlinkWithConversation() throws Exception {
        ...
        mockMvc.perform(put("/api/users/1/unlink/conversation/1"))
                .andExpect(status().isOk());
    }

    @Test
    public void testUnlinkWithConversation_NotFound() throws Exception {
        doThrow(new EntityNotFoundException("User not found")).when(userService).unlinkWithConversation(1L, 1L);
